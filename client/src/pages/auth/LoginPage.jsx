...
const T = {
  ...
  tagline: { en: 'Your Home, Your Accounts', hi: 'अपना घर, अपना हिसाब' },
  terms: {
  ...
  return (
    <div className="min-h-screen min-h-dvh flex flex-col bg-cream dark:bg-gray-950 max-w-[480px] mx-auto">
      ...
      <div className="relative overflow-hidden bg-brand-gradient px-6 pt-12 pb-12 text-white">
        ...
        >
          <span className="font-devanagari text-4xl font-extrabold text-white">ख</span>
        </motion.div>
        <motion.div
        ...
        >
          ...
          <p className="text-white/85 text-lg font-devanagari">अपना घर, अपना हिसाब</p>
